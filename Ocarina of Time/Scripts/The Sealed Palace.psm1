...
function CreateTabMain() {
    ...
    CreateReduxCheckbox -Name "FastRang" 	  -Text "Quicker Boomerang" 	      -Info "Boomerang flys faster and returns quicker, the return timer is reduced to approximate the original distance." -Credits "Anthrogi"
...
function CreateTabDifficulty() {
    ...
    CreateReduxComboBox -Name "Damage"     -Text "Damage"       -Items @("1x Damage", "2x Damage", "4x Damage", "8x Damage", "OHKO Mode") -Info "Set the amount of damage you'll receive.`nOHKO Mode = You die in one hit!" -Credits "Admentus (original) & Anthrogi (ported)"
    ...
    CreateReduxTextBox -Name "FireArrow"   -Text "Fire Arrow"    -Value 4  -Max 96 -Info "Set the magic cost for using Fire Arrows.`n48 is the maximum amount of the standard magic meter while 96 is the maximum amount of the double magic meter."   -Credits "Admentus (original) & Anthrogi (ported)"
    CreateReduxTextBox -Name "IceArrow"    -Text "Ice Arrow"     -Value 4  -Max 96 -Info "Set the magic cost for using Ice Arrows.`n48 is the maximum amount of the standard magic meter while 96 is the maximum amount of the double magic meter."    -Credits "Admentus (original) & Anthrogi (ported)"
    CreateReduxTextBox -Name "LightArrow"  -Text "Light Arrow"   -Value 8  -Max 96 -Info "Set the magic cost for using Light Arrows.`n48 is the maximum amount of the standard magic meter while 96 is the maximum amount of the double magic meter."  -Credits "Admentus (original) & Anthrogi (ported)"
    CreateReduxTextBox -Name "Teleport"    -Text "Farore's Wind" -Value 12  -Max 96 -Info "Set the magic cost for using Farore's Wind.`n48 is the maximum amount of the standard magic meter while 96 is the maximum amount of the double magic meter."  -Credits "Admentus (original) & Anthrogi (ported)"
    CreateReduxTextBox -Name "Barrier"     -Text "Nayru's Love"  -Value 24  -Max 96 -Info "Set the magic cost for using Nayru's Love.`n48 is the maximum amount of the standard magic meter while 96 is the maximum amount of the double magic meter."  -Credits "Admentus (original) & Anthrogi (ported)"
    CreateReduxTextBox -Name "Burst"  	   -Text "Din's Fire"    -Value 12  -Max 96 -Info "Set the magic cost for using Din's Fire.`n48 is the maximum amount of the standard magic meter while 96 is the maximum amount of the double magic meter."  -Credits "Admentus (original) & Anthrogi (ported)"
}
...
function CreateTabEquipment() {
    ...
    CreateReduxComboBox -Name "ShieldRecoil" -Text "Shield Recoil" -Default "Normal" -Items @("None", "Little", "Normal", "Big", "Huge") -Info "Choose the pushback rate when getting hit while shielding." -Credits "Admentus (ROM & original), Aegiker (RAM & original) & Anthrogi (ported)"
    CreateReduxSlider  -Name "Sword1" -Default 3000 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Text "Sword 1"     	-Info "Set the hitbox length of the Kokiri Sword." -Credits "Admentus (original) & Anthrogi (ported)" 
    CreateReduxSlider  -Name "Sword2" -Default 4000 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Text "Sword 2"     	-Info "Set the hitbox length of the Master Sword." -Credits "Admentus (original) & Anthrogi (ported)"
    CreateReduxSlider  -Name "Sword3" -Default 5500 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Text "Sword 3" 	-Info "Set the hitbox length of the Giant's_Knife/Biggoron_Sword." -Credits "Admentus (original) & Anthrogi (ported)"
    CreateReduxSlider  -Name "BrokenSword3" -Default 1500 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Text "Broken Sword 3" 	-Info "Set the hitbox length of the Broken Giant's Knife." -Credits "Admentus (original) & Anthrogi (ported)"
    CreateReduxSlider  -Name "Stick" -Default 5000 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Text "Stick" 		-Info "Set the hitbox length of the Deku Stick.`nNOTE: Also affects the tip that can be set aflame, use carefully if trying to set it as a torch!" -Credits "Anthrogi"
    CreateReduxSlider  -Name "Hammer" -Default 2500 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Text "Hammer"  	-Info "Set the hitbox length of the Megaton Hammer." -Credits "Admentus (original) & Anthrogi (ported)"
    CreateReduxSlider  -Name "Hookshot" -Default 13 -Min 10 -Max 110 -Freq 10 -Small 5 -Large 10 -Text "Hookshot"  		-Info "Set the length of the Hookshot." -Credits "Admentus (original) & Anthrogi (ported)" -Warning "Going above the default length by a certain amount can look weird."
    CreateReduxSlider  -Name "Longshot" -Default 104 -Min 10 -Max 110 -Freq 10 -Small 5 -Large 10 -Text "Longshot"  		-Info "Set the length of the Longshot." -Credits "Admentus (original) & Anthrogi (ported)" -Warning "Going above the default length by a certain amount can look weird."
}
...
function CreateAttackTrailColorOptions() {
    ...
    CreateReduxComboBox -Name "AttackTrail" -Text "Attack Trail Color" -Items @("White", "Red", "Green", "Blue", "Cyan", "Magenta", "Orange", "Gold", "Purple", "Pink", "Randomized", "Custom") -Default 1 -Info ("Select a preset for the attack trail color.") -Credits "Ported from Rando"
    ...
    CreateReduxComboBox -Name "Duration1" -Text "Attack Trail Duration" -Items @("Disabled", "Default", "Long", "Longer", "Lightsaber") -Default 2 -Info "Select the attack trail's duration." -Credits $credits
