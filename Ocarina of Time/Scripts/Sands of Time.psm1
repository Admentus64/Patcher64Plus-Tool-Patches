function ByteOptions() {
    ...
    elseif (IsText -Elem $Redux.Hero.Damage -Compare "OHKO Mode")   { ChangeBytes -Offset "2088154" -Values "2A03" }
...
function CreateOptions() {
    ...
    CreateReduxComboBox -Name "Sword2" -Text "Sword 2" -Items ("Default", "Big", "Very Big") -Info "Select the length size of the custom Master Sword." -Credits "Admentus (original) & Anthrogi (ported)"
    CreateReduxComboBox -Name "Sword3" -Text "Sword 3" -Items ("Default", "Big", "Very Big") -Info "Select the length size of the custom Giant's_Knife/Biggoron's_Sword." -Credits "Admentus (original) & Anthrogi (ported)"
    CreateReduxComboBox -Name "Hammer" -Text "Hammer" -Items ("Default", "Big", "Very Big") -Info "Select the length size of the custom Megaton Hammer." -Credits "Admentus (original) & Anthrogi (ported)"
    CreateReduxSlider -Name "BrokenSword3" -Default 1500 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Text "Broken Sword 3" -Info "Set the hitbox length of the custom Broken Giant's Knife." -Credits "Admentus (original) & Anthrogi (ported)"
    CreateReduxSlider -Name "Stick" -Default 5000 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Text "Stick" -Info "Set the hitbox length of the custom Deku Stick.`nNOTE: Also affects the tip that can be set aflame, use carefully if trying to set it as a torch!" -Credits "Anthrogi"
